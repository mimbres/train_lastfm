...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_lastfm_mlp_reg1/")
...
#%% Train/test methods
def Train():
    mtrain_loader = LastFMDataloader(mtrain_mode=True, normalization_factor=1, batch_size=TR_BATCH_SZ, shuffle=True)
...
def Validate():
    mval_loader = LastFMDataloader(mtrain_mode=False, normalization_factor=1, batch_size=TS_BATCH_SZ, shuffle=False)
